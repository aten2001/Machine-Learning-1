...
public class TravelingSalesman_Toy {
    ...
    public static void main(String[] args) {
       ...
       //int[] iters = {10,1000,2000,3000,4000,5000,7500,10000,20000};
	   int[] iters = {10, 100, 1000, 5000, 10000, 50000, 100000, 200000};
        //int[] iters = {10};
        int testRuns = 3;
        ...
        for (int iter : iters) {
            ...
            String final_result = "";
            final_result = iter + "," + "rhc" + "," + Double.toString(average_rhc) + "," + Double.toString(averagetime_rhc) + "," +
                    "sa" + "," + Double.toString(average_sa) + "," + Double.toString(averagetime_sa) + "," +
                    "ga" + ","+ Double.toString(average_ga) + "," + Double.toString(averagetime_ga);
