...
public class phishing_ga_val_iter {
    ...
    public static void main(String[] args) {
		...
		//Optimal Values 100 50	50

		
		//int[] population = {100,100,100,100};
		int[] population = {100};
		
		//int[] mate = {30,30,50,50};
		int[] mate = {50};
		
		//int[] mute = {25,50,25,50};
		int[] mute = {50};
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int q = 0; q < population.length; q++) {
                ...
                write_output_to_file("Optimization_Results", "phishing_results_ga_iter.csv", final_result, true);
