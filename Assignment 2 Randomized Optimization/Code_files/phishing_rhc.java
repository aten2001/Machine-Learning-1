...
public class phishing_rhc {
    ...
    public static void main(String[] args) {
        ...
        int[] iterations = {10,100,500,1000,2500,5000,10000};
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int i = 0; i < oa.length; i++) {
                ...
                for (int j = 0; j < train_set.length; j++) {
					...
					//int_result = k + "," + actual + "," + predicted + "," + trash;
					//write_output_to_file("Optimization_Results", "train_rhc.csv", int_result, true);
