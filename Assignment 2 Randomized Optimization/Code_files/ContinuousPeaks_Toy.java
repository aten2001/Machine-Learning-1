...
public class ContinuousPeaks_Toy {
    ...
    public static void main(String[] args) {
        ...
        for (int iter : iters) {
            ...
            String final_result = "";
            final_result = iter + "," + "rhc" + "," + Integer.toString(average_rhc) + "," + Double.toString(averagetime_rhc) + "," +
                    "sa" + "," + Integer.toString(average_sa) + "," + Double.toString(averagetime_sa) + "," +
                    "ga" + "," + Integer.toString(average_ga) + "," + Double.toString(averagetime_ga);
